...
| `GANTI-URL-BACKEND-ANDA.vercel.app` | Domain project backend Vercel Anda | `const API=...` di semua HTML dashboard admin & storefront |
| `ganti-domain-toko-anda.com` | Domain custom storefront Anda | fallback `FRONTEND_URL` di `publicRoutes.js` |
